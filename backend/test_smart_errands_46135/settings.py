"""
Django settings for test_smart_errands_46135 project.
...
ROOT_URLCONF = 'test_smart_errands_46135.urls'
...
WSGI_APPLICATION = 'test_smart_errands_46135.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_smart_errands_46135 API",
    "DESCRIPTION": "API documentation for test_smart_errands_46135 App",
    "VERSION": "v1",
}
